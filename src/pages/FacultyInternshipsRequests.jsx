...
export default function FacultyInternshipsRequests() {
  ...
  const fetchAllEvents = async () => {
    try {
      ...
      console.error('Failed to fetch all internships for counts:', err);
    }
  };
  ...
  return (
    ...
    >
      <header className="text-center mb-10 mt-10">
        <div>
          <h1 className="text-[2.2rem] font-bold text-slate-800 mb-2 max-sm:text-[1.5rem]">Internship Requests</h1>
